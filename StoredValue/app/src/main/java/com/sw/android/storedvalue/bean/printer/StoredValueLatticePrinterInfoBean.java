...
/**
 * Author FGB
 * Description 充值点阵打印信息Bean
 * Created at 2017/7/21 16:17
 * Version 1.0
 */

public class StoredValueLatticePrinterInfoBean {
     ...
     */
    public static void printLattice(LatticePrinter latticePrinter, StoredValueLatticePrinterBean printerBean) {
        String mediumSpline = "";
...
//                IPrint.Gravity.CENTER);
        ...
        String time = "充值时间:"+ AbDateUtil.getCurrentDate("yyyy-MM-dd HH:mm:ss");
        ...
        String activity = "活动:"+printerBean.getTitle();
        latticePrinter.printText(activity + "\n", LatticePrinter.FontFamily.SONG,
                LatticePrinter.FontSize.MEDIUM, LatticePrinter.FontStyle.BOLD);

        String totalPrice = "充值金额:"+printerBean.getAmount();
        latticePrinter.printText(totalPrice + "\n", LatticePrinter.FontFamily.SONG,
                LatticePrinter.FontSize.MEDIUM, LatticePrinter.FontStyle.BOLD);

        String givenAmount = "赠送金额:"+(int)printerBean.getGivenAmount();
        latticePrinter.printText(givenAmount + "\n", LatticePrinter.FontFamily.SONG,
                LatticePrinter.FontSize.MEDIUM, LatticePrinter.FontStyle.BOLD);

        String pay = "支付方式:"+printerBean.getPayType();
        latticePrinter.printText(pay + "\n", LatticePrinter.FontFamily.SONG, LatticePrinter.FontSize.MEDIUM,
                LatticePrinter.FontStyle.BOLD);

        String vipNumer = "会员卡号:"+printerBean.getVipId();
        ...
        String UsableBalance = "充值余额:"+printerBean.getUsableBalance();
        latticePrinter.printText(UsableBalance + "\n", LatticePrinter.FontFamily.SONG, LatticePrinter.FontSize.MEDIUM,
                LatticePrinter.FontStyle.BOLD);

        String GivenBalance = "赠送余额:"+printerBean.getGivenBalance();
        latticePrinter.printText(GivenBalance + "\n", LatticePrinter.FontFamily.SONG,
                LatticePrinter.FontSize.MEDIUM, LatticePrinter.FontStyle.BOLD);

        String TotalBalance = "总余额:"+printerBean.getTotalBalance();
        latticePrinter.printText(TotalBalance + "\n", LatticePrinter.FontFamily.SONG, LatticePrinter.FontSize.MEDIUM,
                LatticePrinter.FontStyle.BOLD);
